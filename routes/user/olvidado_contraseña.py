...
from routes.user.enviar_correo import enviar_correo
from routes.user.tokens import obtener_clave_secreta
...
def olvidado_contraseña():
   ...
   return render_template('usuario_configuracion/olvidado_contraseña.html', mensaje=mensaje, tipo_mensaje=tipo_mensaje)
